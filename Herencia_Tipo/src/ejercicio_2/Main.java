...
public class Main {
    public static void main(String[] args) {
    	...
    	personajes.add(new Mago("Magico", 10, p2));
    	personajes.add(new Ogro("Feo", 10, p3));
        
		System.out.println(p1.getPosx() + " y " + p1.getPosy() + "antes");
    	p1.incrementaPos(1, 5);
    	System.out.println(p1.getPosx() + " y " + p1.getPosy() + "despues");
    	
    	System.out.println(p2.getPosx() + " y " + p2.getPosy()  + "antes");
    	p2.setXY(10, 80);
    	System.out.println(p2.getPosx() + " y " + p2.getPosy() + "despues");
    	
    	System.out.println(p3.getPosx() + " y " + p3.getPosy()  + "antes");
    	p3.incrementaPos(3, 0);
    	System.out.println(p3.getPosx() + " y " + p3.getPosy() + "despues");
    }
}
